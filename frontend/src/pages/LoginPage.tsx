...
import { Cpu, ShieldAlert, Key, Mail, ArrowLeft } from 'lucide-react';
      ...
      >
        ...
        <div className="glass-card rounded-2xl p-8 border border-slate-800 shadow-2xl">
          <div className="mb-6">
            ...
            <p className="text-slate-400 text-sm mt-1">Sign in to resume your interview prep</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Link to="/forgot-password" className="text-xs text-[#8B5CF6] hover:text-[#a78bfa] transition-colors font-medium">Forgot password?</Link>
              </div>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-500">
          ...
          <div className="mt-8 text-center text-xs text-slate-400">
            ...
            <Link to="/register" className="text-[#8B5CF6] hover:underline font-semibold">Sign up free</Link>
          </div>
        </div>
      </motion.div>
    </div>
