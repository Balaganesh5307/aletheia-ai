...
import { Cpu, ShieldCheck, Mail, ArrowLeft, Send } from 'lucide-react';
      ...
      >
        ...
        <div className="glass-card rounded-2xl p-8 border border-slate-800 shadow-2xl">
          <div className="mb-6">
            ...
            <p className="text-slate-400 text-sm mt-1">We will email you a secure token link to reset your password</p>
          </div>
          ...
          {!message ? (
            ...
            <div className="text-center pt-4">
              <Link to="/login" className="px-6 py-2.5 rounded-xl bg-slate-800 border border-slate-700 hover:bg-slate-700/80 transition-all text-sm font-semibold inline-block">
                Return to Sign In
              </Link>
            </div>
          )}
